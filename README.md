...
- As an Athlete I can view my macros (protein, carbs, fats etc.) to achieve my required daily intake.
- As an Athlete I can view recipes for quick and easy meals that can sustain me.
- As an Athlete I can ask the AI assistant to create a nutrition plan for me that fulfills my needs.
- As an Athlete I can ask the AI assistant questions regarding the recipes to clear out any confusion.
- As an Athlete I can filter for high protein, high carb meals for training days.
- As an Athlete I can ask the AI assistant beginner friendly explainations for what is best for me.
...
- As a user who wants to lose weight I can view recipes for meals which contain fewer calories.
...
- As a college student I want beginner friendly tips from the AI assistant if I want to start my fitness journey based on my goals.
